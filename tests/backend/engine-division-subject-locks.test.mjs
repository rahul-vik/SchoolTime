...
test("divisionSubjectTeacherLocks pre-seed before greedy placement", () => {
  ...
  const out = runTimetableEngine({
    ...
    workingDays,
    teacherSubjects: [],
    divisionSubjectTeacherLocks: [{ divisionId: divId, subjectId: "sub-math", teacherId: "t-general" }],
    freePeriodRules: [],
    fixedSlots: [],
    subjectAllocations: [],
    schedulingRules: [],
  ...
  assert.ok(mathLessons.every((e) => e.teacherId === "t-general"));
});
