...
function buildDemoTenantState(orgName) {
  ...
  return {
    ...
    subjects: [
      { id: "sub1", name: "English", code: "ENG", category: "LANGUAGE", weeklyPeriods: 6, maxPerDay: 2, priorityWeight: 8, colorHex: "#7c3aed", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
      { id: "sub2", name: "Mathematics", code: "MATH", category: "CORE", weeklyPeriods: 6, maxPerDay: 2, priorityWeight: 10, colorHex: "#0369a1", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
      { id: "sub3", name: "Science", code: "SCI", category: "CORE", weeklyPeriods: 5, maxPerDay: 2, priorityWeight: 10, colorHex: "#0e7490", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
      { id: "sub4", name: "Social Studies", code: "SS", category: "NON_CORE", weeklyPeriods: 4, maxPerDay: 1, priorityWeight: 6, colorHex: "#0891b2", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
      { id: "sub5", name: "Computer Lab", code: "CS", category: "PRACTICAL", weeklyPeriods: 2, maxPerDay: 1, priorityWeight: 4, colorHex: "#059669", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
      { id: "sub6", name: "Physical Education", code: "PE", category: "EXTRA_CURRICULAR", weeklyPeriods: 2, maxPerDay: 1, priorityWeight: 3, colorHex: "#d97706", mediumIds: ["m1", "m2"], standardIds: ["s4", "s5", "s6"] },
    ],
    teachers: [
      { id: "t1", firstName: "Priya", lastName: "Sharma", employeeCode: "T001", email: "priya@schooltime.demo", maxPerDay: 6, maxPerWeek: 30, mediumIds: ["m1"], subjectIds: ["sub1"], primarySubjectId: "sub1", freeMorningPeriods: 0, freeEveningPeriods: 0, maxContinuousSameSubjectPerDivision: 2, maxContinuousAnySubjectPerDivision: 3, assignedDivisionIds: ["d1", "d2", "d3"], classTeacherDivisionIds: ["d1"], primaryClassTeacherDivisionId: "d1" },
      { id: "t2", firstName: "Rajesh", lastName: "Kumar", employeeCode: "T002", email: "rajesh@schooltime.demo", maxPerDay: 6, maxPerWeek: 30, mediumIds: ["m1", "m2"], subjectIds: ["sub2"], primarySubjectId: "sub2", freeMorningPeriods: 1, freeEveningPeriods: 0, maxContinuousSameSubjectPerDivision: 2, maxContinuousAnySubjectPerDivision: 3, assignedDivisionIds: ["d1", "d2", "d3", "d4", "d5"], classTeacherDivisionIds: ["d3"], primaryClassTeacherDivisionId: "d3" },
      { id: "t3", firstName: "Meena", lastName: "Nair", employeeCode: "T003", email: "meena@schooltime.demo", maxPerDay: 6, maxPerWeek: 30, mediumIds: ["m1", "m2"], subjectIds: ["sub3"], primarySubjectId: "sub3", freeMorningPeriods: 0, freeEveningPeriods: 1, maxContinuousSameSubjectPerDivision: 2, maxContinuousAnySubjectPerDivision: 3, assignedDivisionIds: [], classTeacherDivisionIds: ["d4"], primaryClassTeacherDivisionId: "d4" },
    ...
    schedulingRules: [
      { id: "r1", subjectId: "sub6", ruleType: "BOTH_BOUNDARY", isActive: true, note: "PE away from boundary slots" },
      { id: "r2", subjectId: "sub5", ruleType: "EXCLUDE_DAY", isActive: true, dayOfWeek: "MONDAY", note: "Lab not on Monday" },
    ],
